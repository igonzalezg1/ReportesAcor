...
{
    public function getRespuestas($id_encuesta, $id_bloque, $punto)
    {
        ...
        $respuestas = self::obtener($punto, $preguntas, $id_bloque, $email);
        ...
        //return $preguntas;
        return view('reportes.repotes', compact('respuestas','preguntas', 'carpeta2', 'bloque','id_bloque','id_encuesta','punto'));
    }


    //Consultar respuestas

    static public function obtener(Int $punto, array $preguntas, Int $idBloque, String $email)
    {
        $self = new Self;
        switch ($punto) {
            case 9: //Lectura energeticos
                return $self->consultaGeneral($preguntas, $idBloque, $email);
                break;
    ...
    private function consultar(String $consulta = '')
    {
        if ($consulta == '') {
            return [];
        }
    ...
    private function consultaGeneral(array $preguntas, Int $idBloque, String $email, String $OrderBy = 'DESC')
    {
        $consulta = "SELECT ";
