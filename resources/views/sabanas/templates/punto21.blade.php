...
<div id="sabanaHeader" class="row">
    <div class="col-12 col-md-6">
        <div style="margin: 120px 0px 120px 0px !important;">
            <div class="center-item">
                <h2 style="margin-bottom: -3px;">Punto 21</h2>
                <span>Realizacion del mantenimiento del 15% de las habitaciones del hotel aplicacion del formato
                    técnico</span>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6">
        <ol>
            <li>Menor a 5 meses: <span class="text-primary"><b>FECHA</b></span></li>
            <li>Entre 5 y 6 Meses: <span class="text-success"><b>FECHA</b></span></li>
            <li>Mayor a 6 Meses: <span class="text-orange"><b>FECHA</b></span></li>
